...
var useScrollData = function (options) {
    ...
    var _a = useState(INITIAL_DATA), data = _a[0], setData = _a[1];
    var startValues = useRef(INITIAL_DATA);
    var frameValues = useRef(INITIAL_DATA);
    var startTimestamp = useRef();
    var frameTimestamp = useRef();
    ...
    function frame(timestamp) {
        ...
        var nextframeValues = __assign(__assign({}, frameValues.current), { scrolling: true, time: time,
            direction: direction,
            speed: speed,
